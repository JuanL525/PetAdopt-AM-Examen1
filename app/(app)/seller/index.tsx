...
export default function SellerDashboard() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Lista de salas */}
      <Text style={[styles.sectionTitle, { paddingHorizontal: 20, color: '#94a3b8', marginBottom: 12 }]}>
          ...
          <Animated.View entering={SlideInLeft.duration(300)} style={styles.drawerContainer}>
            ...
            <View style={styles.drawerHeader}>
              ...
              <View style={styles.drawerProfile}>
                <View style={[styles.drawerAvatar, { backgroundColor: 'rgba(96, 165, 250, 0.15)' }]}>
                  <Text style={[styles.drawerAvatarText, { color: '#60a5fa' }]}>
                ...
                <View style={styles.drawerRoleBadge}>
                  <Text style={styles.drawerRoleText}>🏷 Vendedor</Text>
                </View>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  createSection: {
    margin: 20,
    backgroundColor: 'rgba(22, 32, 51, 0.85)', // More opaque glass card
    borderRadius: 18,
    padding: 20,
    borderWidth: 1.2,
  ...
  createBtn: {
    ...
    height: 48,
    borderRadius: 12,
    backgroundColor: '#6366f1', // glowing indigo button
  ...
  drawerContainer: {
    ...
    left: 0,
    width: 280,
    backgroundColor: 'rgba(15, 23, 42, 0.95)', // Frosted dark container
